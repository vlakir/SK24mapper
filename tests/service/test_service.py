...
class TestService:
    ...
    async def test_download_satellite_rectangle_basic(self, mock_grid, mock_session, base_settings, tmp_path):
        # Setup mocks
        ...
        # Network validation probes are no longer invoked here — real tile-fetch
        # paths surface the same errors.
