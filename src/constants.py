...
GRID_FONT_PATH: None  # Путь к TTF/OTF обычного шрифта (если None — использовать DejaVu из Pillow)
...
GRID_FONT_PATH_BOLD = None  # Путь к жирному шрифту TTF/OTF (если None — DejaVuSans-Bold.ttf)
